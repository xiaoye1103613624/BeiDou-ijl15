...
IWzGr2DLayer : IWzVector2D
{
    ...
    virtual HRESULT __stdcall put_visible (
        /*[in]*/ int pnVisible ) = 0;
    virtual HRESULT __stdcall raw_RenderFlash (
        /*[in]*/ int nRenderFlash ) = 0;
};
...
inline HRESULT IWzGr2DLayer::RenderFlash ( int nRenderFlash ) {
    HRESULT _hr = raw_RenderFlash(nRenderFlash);
    if (FAILED(_hr)) _com_issue_errorex(_hr, this, __uuidof(this));
    return _hr;
}
