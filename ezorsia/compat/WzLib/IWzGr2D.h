...
inline HRESULT IWzGr2D::InitializeFlashByDevice ( ) {
    HRESULT _hr = raw_InitializeFlashByDevice();
    if (FAILED(_hr)) _com_issue_errorex(_hr, this, __uuidof(this));
    return _hr;
}

inline HRESULT IWzGr2D::LoadMediaFile ( LPSTR sSource ) {
    HRESULT _hr = raw_LoadMediaFile(sSource);
    if (FAILED(_hr)) _com_issue_errorex(_hr, this, __uuidof(this));
    return _hr;
}

inline HRESULT IWzGr2D::SetFlashAbsLocation ( int nX, int nY ) {
    HRESULT _hr = raw_SetFlashAbsLocation(nX, nY);
    if (FAILED(_hr)) _com_issue_errorex(_hr, this, __uuidof(this));
    return _hr;
}

inline HRESULT IWzGr2D::RenderFlash ( ) {
    HRESULT _hr = raw_RenderFlash();
    if (FAILED(_hr)) _com_issue_errorex(_hr, this, __uuidof(this));
    return _hr;
}

inline HRESULT IWzGr2D::ReleaseFlash ( ) {
    HRESULT _hr = raw_ReleaseFlash();
    if (FAILED(_hr)) _com_issue_errorex(_hr, this, __uuidof(this));
    return _hr;
}

inline int IWzGr2D::IsRenderFlash ( ) {
    int _result = 0;
