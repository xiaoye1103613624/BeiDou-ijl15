...
void AttachPersonalShopMod() {
    // Client slot grid is driven by PLAYER_INTERACTION slotMax byte (server writeByte(0x20)).
    // PersonalShop/backgrnd 525x553 is deployed in live UIWindow.img; no draw-loop patch needed.
    // Meso display in this UI: mesouncap hooks @ 0x006F0388 / 0x006F03BE and HM @ 0x006FBA12.
    PsLog("AttachPersonalShopMod: slotMax=32 packet-driven; UI PersonalShop/backgrnd 525x553; meso via mesouncap");
}
