...
inline constexpr ExtendedBodyPart kBodyParts[] = {
    ...
    // Pocket — native −33; UI = Addon row3 overlay (NOT main red9); NEVER draw cave
    {33, 116, "Po", UiSeat::AddonDock, StorageTier::NativeApplyMax55, false,
     DrawPolicy::AddonOverlay, WireWhen::EquipOpen, false, 6, 147, true, "Addon row3 pocket"},
    // True split: 109 → −10 shield; 134/135 → −62 Addon aux (may wear both)
    ...
    {62, 134, "Aw", UiSeat::AddonDock, StorageTier::SidecarZRef, true,
     DrawPolicy::AddonOverlay, WireWhen::Always, true, 39, 147, true, "Addon row3 aux −62"},
    {62, 135, "Aw", UiSeat::AddonDock, StorageTier::SidecarZRef, true,
     DrawPolicy::AddonOverlay, WireWhen::Always, true, 39, 147, true, "Addon row3 aux −62"},
...
// Abandoned main red9/10 — empty table (pocket/aux on Addon kAddonDockSeats).
inline constexpr XyRemap kEquipOpenXyRemaps[] = {
    {0, 0, 0, 0, WireWhen::GatedOff, "no main XY wire (row3 Addon)"},
};
